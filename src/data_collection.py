        ...
        while True:
            ...
            if key == ord('s'):
                if img_file_loc is None:
                    ...
                    saveImage(data_dir,warped,state,img_file_desc)
                else:
                    saveImage(data_dir,warped,img_file_loc,img_file_desc)
                #saveImage(data_dir,warped,state,"Warped")
                #saveImage(data_dir,original,state,"Original")
